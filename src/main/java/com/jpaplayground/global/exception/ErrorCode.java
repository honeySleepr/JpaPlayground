...
public enum ErrorCode {
	...
	JWT_REFRESH_TOKEN_MISSING(BAD_REQUEST,
		"AccessToken이 만료되었습니다. 재발급을 위한 RefreshToken이 RefreshToken Header에 포함되지 않았습니다"),
	MEMBER_ID_HEADER_MISSING(BAD_REQUEST, "Header에 memberId가 포함되지 않았습니다"),
	JWT_ACCESS_TOKEN_INVALID(UNAUTHORIZED, "AccessToken이 유효하지 않습니다"),
	JWT_REFRESH_TOKEN_INVALID(UNAUTHORIZED, "RefreshToken이 유효하지 않습니다"),
	JWT_REFRESH_TOKEN_EXPIRED(UNAUTHORIZED, "RefreshToken이 만료되었습니다"),
	JWT_REFRESH_TOKEN_MISMATCH(UNAUTHORIZED, "RefreshToken이 일치하지 않습니다"),
